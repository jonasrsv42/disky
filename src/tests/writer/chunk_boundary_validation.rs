...
fn test_exact_multi_block_chunk_validation() {
    ...
    let header2_prev_chunk = u64::from_le_bytes([
        file_data[block_size as usize + 8],
        file_data[block_size as usize + 9],
        file_data[block_size as usize + 10],
        file_data[block_size as usize + 11],
        file_data[block_size as usize + 12],
        file_data[block_size as usize + 13],
        file_data[block_size as usize + 14],
        file_data[block_size as usize + 15],
    ]);
    let header2_next_chunk = u64::from_le_bytes([
        file_data[block_size as usize + 16],
        file_data[block_size as usize + 17],
        file_data[block_size as usize + 18],
        file_data[block_size as usize + 19],
        file_data[block_size as usize + 20],
        file_data[block_size as usize + 21],
        file_data[block_size as usize + 22],
        file_data[block_size as usize + 23],
    ]);
    ...
    println!(
        "Header 2: previous_chunk={}, expected={}",
        header2_prev_chunk, 0
    );
